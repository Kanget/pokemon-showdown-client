...
return prefix+"//raw.githubusercontent.com/lhsackerson/pokemonshowdownimages/master/";
}();this.
...
function BattleLog(elem,scene,innerElem){var _this=this;this.scene=null;this.preemptElem=null;this.atBottom=true;this.battleParser=null;this.joinLeave=null;this.perspective=-1;this.
...
if(toID(args[2])!==toID(_user.name)){
divHTML='<small>'+BattleLog.escapeHTML(_user.group+_user.name)+' renamed from '+BattleLog.escapeHTML(args[2])+'.</small>';
}
break;
}
case'chatmsg':case'':
