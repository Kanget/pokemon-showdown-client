...
var _serverPokemon=this.battle.myPokemon[index];
var gmaxMove=args[3]?this.battle.dex.getMove(args[3]):undefined;
if(!pokemon)return false;
buf=this.showMoveTooltip(move,type,pokemon,_serverPokemon,gmaxMove);
break;
}
...
_serverPokemon2=this.battle.myPokemon[activeIndex];
}
if(!_pokemon2)return false;
buf=this.showPokemonTooltip(_pokemon2,_serverPokemon2,true);
break;
}
case'switchpokemon':{
...
buf=this.showPokemonTooltip(_pokemon3,_serverPokemon3);
break;
}
case'field':{
